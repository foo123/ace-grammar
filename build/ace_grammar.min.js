...
*
**/!function(t){"object"==typeof module&&module.exports?t(module.exports):"function"==typeof define&&define.amd?define(["exports"],function(e){t(e)}):t(this)}.call(this,function(t,e){if(!t.AceGrammar){var n,s=t.Classy.Class,i=t.RegExAnalyzer,r="0.3",o=2,h=4,u=8,c=9,a=16,l=32,k=64,p=128,f=256,m=512,d=33,R=34,g=36,y=40,E=48,O=64,v=128,x=4,B=8,T=16,b=32,P=64,A=128,S=256,w=512,L=1024,_=2048,C=4096,q=8192,N={ONEOF:A,EITHER:A,ALL:S,ALLOF:S,ZEROORONE:w,ZEROORMORE:L,ONEORMORE:_},z={BLOCK:P,"ESCAPED-BLOCK":b,SIMPLE:T,GROUP:C,NGRAM:q,"N-GRAM":q},M=Array.prototype.slice,j=(Array.prototype.splice,Array.prototype.concat,Object.prototype.hasOwnProperty),G=Object.prototype.toString,I=function(t){var n=typeof t,s=G.call(t);return"number"==n||t instanceof Number?o:!0===t||!1===t?h:t&&("string"==n||t instanceof String)?1==t.length?c:u:t&&("[object RegExp]"==s||t instanceof RegExp)?a:t&&("[object Array]"==s||t instanceof Array)?l:t&&"[object Object]"==s?k:null===t?p:e===t?f:m},D=function(t,e){return e||l!=I(t)?[t]:t},K=function(t,e){return t=D(t,e),(e||l!=I(t[0]))&&(t=[t]),t},U=function(t){var e,n=I(t);if(k!=n&&l!=n)return t;var s,i={};for(s in t)j.call(t,s)&&(e=I(t[s]),i[s]=k==e?U(t[s]):l==e?t[s].slice():t[s]);return i},$=function(){var t=M.call(arguments),e=t.length;if(1>e)return null;if(2>e)return U(t[0]);var n,s,i,r,o=t.shift(),h=U(o);for(e--,s=0;e>s;s++)if(n=t.shift())for(i in n)j.call(n,i)&&(j.call(o,i)?(r=I(o[i]),k&~u&r&&(h[i]=$(o[i],n[i]))):h[i]=U(n[i]));return h},F=s({constructor:function(t,e){e?(this.stream=e,this.string=""+e.string,this.start=e.start,this.pos=e.pos):(this.string=""+t,this.start=this.pos=0)},stream:null,string:"",start:0,pos:0,sol:function(){return 0==this.pos},eol:function(){return this.pos>=this.string.length},matchChar:function(t,e){e=!1!==e;var n=this.string.charAt(this.pos)||"";return t==n?(e&&(this.pos+=1,this.stream&&(this.stream.pos=this.pos)),n):!1},matchStr:function(t,e,n){n=!1!==n;var s=this.pos,i=this.string.charAt(s);if(e.peek[i]){var r=t.length,o=this.string.substr(s,r);if(t==o)return n&&(this.pos+=r,this.stream&&(this.stream.pos=this.pos)),o}return!1},matchRegex:function(t,e,n,s){n=!1!==n,s=s||0;var i=this.pos,r=this.string.charAt(i);if(e.peek&&e.peek[r]||e.negativepeek&&!e.negativepeek[r]){var o=this.string.slice(i).match(t);return!o||o.index>0?!1:(n&&(this.pos+=o[s].length,this.stream&&(this.stream.pos=this.pos)),o)}return!1},skipToEnd:function(){return this.pos=this.string.length,this.stream&&(this.stream.pos=this.pos),this},peek:function(){return this.string.charAt(this.pos)||e},next:function(){if(this.pos<this.string.length){var t=this.string.charAt(this.pos++);return this.stream&&(this.stream.pos=this.pos),t}return e},backUp:function(t){return this.pos-=t,this.stream&&(this.stream.pos=this.pos),this},backTo:function(t){return this.pos=t,this.stream&&(this.stream.pos=this.pos),this},eatSpace:function(){for(var t=this.pos;/[\s\u00a0]/.test(this.string.charAt(this.pos));)++this.pos;return this.stream&&(this.stream.pos=this.pos),this.pos>t},current:function(){return this.string.slice(this.start,this.pos)},shift:function(){return this.start=this.pos,this}}),H=/([\-\.\*\+\?\^\$\{\}\(\)\|\[\]\/\\])/g,Z=function(t,e){return e.length-t.length},V=function(t,e){return u&I(e)&&u&I(t)&&e.length&&e.length<=t.length&&e==t.substr(0,e.length)},W=function(t,e,n){if(!t||o==I(t))return t;var s=e?e.length||0:0;if(s&&e==t.substr(0,s)){var r,h,u,c="^("+t.substr(s)+")";return n[c]||(r=new RegExp(c),u=new i(r).analyze(),h=u.getPeekChars(),Object.keys(h.peek).length||(h.peek=null),Object.keys(h.negativepeek).length||(h.negativepeek=null),n[c]=[r,h]),n[c]}return t},J=function(t,e){var n,s,i={},r="";for(u==I(e)&&(r=e),n=0,s=t.length;s>n;n++)i[t[n].charAt(0)]=1,t[n]=t[n].replace(H,"\\$1");return[new RegExp("^("+t.sort(Z).join("|")+")"+r),{peek:i,negativepeek:null},1]},Q=s({constructor:function(t,e,n,s){this.name=t,this.pattern=e,this.key=n||0,this.type=s||E},name:null,pattern:null,peek:null,type:null,key:0,toString:function(){var t="[";return t+="Matcher: "+this.name,t+=", Type: "+this.type,t+=", Pattern: "+(this.pattern?this.pattern.toString():null),t+="]"},match:function(){return[this.key,this.pattern]}}),X=s({Extends:Q},{constructor:function(t,e,n){this.name=t,this.pattern=e,this.type=d,this.key=n||0},match:function(t,e){var n;return(n=t.matchChar(this.pattern,e))?[this.key,n]:!1}}),Y=s({Extends:Q},{constructor:function(t,e,n){this.name=t,this.pattern=e,this.peek={peek:{},negativepeek:null},this.peek.peek[""+e.charAt(0)]=1,this.type=R,this.key=n||0},match:function(t,e){var n;return(n=t.matchStr(this.pattern,this.peek,e))?[this.key,n]:!1}}),te=s({Extends:Q},{constructor:function(t,e,n){this.name=t,this.pattern=e[0],this.peek=e[1],this.isComposite=e[2]||0,this.type=g,this.key=n||0},isComposite:0,match:function(t,e){var n;return(n=t.matchRegex(this.pattern,this.peek,e,this.isComposite))?[this.key,n]:!1}}),ee=s({Extends:Q},{constructor:function(t,e,n){this.name=t,this.type=y,this.key=n||0},match:function(t,e){return!1!==e&&t.skipToEnd(),[this.key,""]}}),ne=function(t,e,n,s){n=n||0;var i,r=t+"_SimpleMatcher",a=I(e);return o==a?e:(s[r]||(i=h==a?new Q(r,e,n):p==a?new ee(r,e,n):c==a?new X(r,e,n):u==a?new Y(r,e,n):l==a?new te(r,e,n):e,s[r]=i),s[r])},se=s({Extends:Q},{constructor:function(t,e,n){this.name=t,this.matchers=e,this.type=O,this.useOwnKey=!1!==n},matchers:null,useOwnKey:!0,test:function(t){var e,n,s=this.matchers,i=s.length;for(e=0;i>e;e++)if(n=s[e].test(t))return!0;return!1},match:function(t,e){var n,s,i=this.matchers,r=i.length;for(n=0;r>n;n++)if(s=i[n].match(t,e))return this.useOwnKey?[n,s[1]]:s;return!1}}),ie=function(t,e,n,s,i,r){var o,h,u,c,a,k=!1,p=!1,f=t+"_CompoMatcher";if(!r[f]){if(o=D(e),u=o.length,s)for(c=(u>>1)+1,h=0;c>=h;h++){if(l==I(o[h])||l==I(o[u-1-h])){k=!0;break}if(V(o[h],n)||V(o[u-1-h],n)){p=!0;break}}if(!s||k||p){for(h=0;u>h;h++)o[h]=l==I(o[h])?ie(f+"_"+h,o[h],n,s,i,r):ne(f+"_"+h,W(o[h],n,i),h,r);a=o.length>1?new se(f,o):o[0]}else a=ne(f,J(o,s),0,r);r[f]=a}return r[f]},re=s({Extends:Q},{constructor:function(t,e,n){this.name=t,this.type=v,this.start=new se(this.name+"_StartMatcher",e,!1),this.pattern=this.start.pattern||null,this.end=n},start:null,end:null,test:function(t){return this.start.test(t)},match:function(t,e){var n=this.start.match(t,e);if(n){var s=this.end[n[0]];return o==I(s)&&(s=new Y(this.name+"_EndMatcher",n[1][s+1])),s}return!1}}),oe=function(t,e,n,s,i){var r,o,h,u,c,a,l,k=t+"_BlockMatcher";if(!i[k]){for(u=[],c=[],r=K(e),o=0,h=r.length;h>o;o++)a=ne(k+"_0_"+o,W(r[o][0],n,s),o,i),l=r[o].length>1?ne(k+"_1_"+o,W(r[o][1],n,s),o,i):a,u.push(a),c.push(l);i[k]=new re(k,u,c)}return i[k]},he=s({constructor:function(t){this.id=t||0,this.stack=[],this.inBlock=null,this.endBlock=null,this.currentToken=B},id:0,stack:null,inBlock:null,endBlock:null,currentToken:null,clone:function(){var t=new this.__class__;return t.id=this.id,t.stack=this.stack.slice(),t.inBlock=this.inBlock,t.endBlock=this.endBlock,t.currentToken=this.currentToken,t},toString:function(){return"_"+this.id+"_"+this.inBlock}}),ue=s({constructor:function(t,e,n,s){t&&(this.name=t),e&&(this.token=e),n&&(this.type=n),s&&(this.style=s),this.tokenName=this.name},name:null,token:null,tokenName:null,type:null,style:null,isRequired:!1,ERROR:!1,streamPos:null,stackPos:null,actionBefore:null,actionAfter:null,toString:function(){var t="[";return t+="Tokenizer: "+this.name,t+=", Type: "+this.type,t+=", Token: "+(this.token?this.token.toString():null),t+="]"},required:function(t){return this.isRequired=t?!0:!1,this},pushToken:function(t,e,n){return this.stackPos?t.splice(this.stackPos+(n||0),0,e):t.push(e),this},clone:function(){var t,e,n=M.call(arguments),s=n.length;for(t=new this.__class__,t.name=this.name,t.tokenName=this.tokenName,t.token=this.token,t.type=this.type,t.style=this.style,t.isRequired=this.isRequired,t.ERROR=this.ERROR,t.streamPos=this.streamPos,t.stackPos=this.stackPos,t.actionBefore=this.actionBefore,t.actionAfter=this.actionAfter,e=0;s>e;e++)t[n[e]]=this[n[e]];return t},tokenize:function(t,e){return this.token.match(t)?(e.currentToken=this.type,this.style):!1}}),ce=s({Extends:ue},{constructor:function(t,e,n,s,i){t&&(this.name=t),e&&(this.token=e),n&&(this.type=n),s&&(this.style=s),this.multiline=!1!==i,this.endBlock=null,this.tokenName=this.name},multiline:!1,endBlock:null,tokenize:function(t,e){var n=!1,s=!1;if(e.inBlock==this.name?(s=!0,this.endBlock=e.endBlock):!e.inBlock&&(this.endBlock=this.token.match(t))&&(s=!0,e.inBlock=this.name,e.endBlock=this.endBlock),s){for(this.stackPos=e.stack.length,n=this.endBlock.match(t);!n&&!t.eol();){if(this.endBlock.match(t)){n=!0;break}t.next()}return n=n||!this.multiline&&t.eol(),n?(e.inBlock=null,e.endBlock=null):this.pushToken(e.stack,this),e.currentToken=this.type,this.style}return e.inBlock=null,e.endBlock=null,!1}}),ae=s({Extends:ce},{constructor:function(t,e,n,s,i,r){t&&(this.name=t),e&&(this.token=e),n&&(this.type=n),s&&(this.style=s),this.escape=i||"\\",this.multiline=r||!1,this.endBlock=null,this.tokenName=this.name},escape:"\\",tokenize:function(t,e){var n="",s=!1,i=!1,r=!1;if(e.inBlock==this.name?(i=!0,this.endBlock=e.endBlock):!e.inBlock&&(this.endBlock=this.token.match(t))&&(i=!0,e.inBlock=this.name,e.endBlock=this.endBlock),i){for(this.stackPos=e.stack.length,s=this.endBlock.match(t);!s&&!t.eol();){if(!r&&this.endBlock.match(t)){s=!0;break}n=t.next(),r=!r&&n==this.escape}return s=s||!(r&&this.multiline),s?(e.inBlock=null,e.endBlock=null):this.pushToken(e.stack,this),e.currentToken=this.type,this.style}return e.inBlock=null,e.endBlock=null,!1}}),le=s({Extends:ue},{constructor:function(t,e){t&&(this.name=t),e&&(this.type=e),this.tokenName=this.name},tokens:null,buildTokens:function(t){return t&&(this.tokens=D(t),this.token=this.tokens[0]),this}}),ke=s({Extends:le},{constructor:function(t,e){this.type=w,t&&(this.name=t),e&&this.buildTokens(e),this.tokenName=this.name},tokenize:function(t,e){this.isRequired=!1,this.ERROR=!1,this.streamPos=t.pos;var n=this.token.tokenize(t,e);return token.ERROR&&t.backTo(this.streamPos),n}}),pe=s({Extends:le},{constructor:function(t,e){this.type=L,t&&(this.name=t),e&&this.buildTokens(e),this.tokenName=this.name},tokenize:function(t,e,n){var s,i,r,o=this.tokens.length,h=0;for(this.isRequired=!1,this.ERROR=!1,this.streamPos=t.pos,this.stackPos=e.stack.length,s=0;o>s;s++){if(i=this.tokens[s],r=i.tokenize(t,e,n),!1!==r)return this.pushToken(e.stack,this),r;i.ERROR&&(h++,t.backTo(this.streamPos))}return!1}}),fe=s({Extends:le},{constructor:function(t,e){this.type=_,t&&(this.name=t),e&&this.buildTokens(e),this.foundOne=!1,this.tokenName=this.name},foundOne:!1,tokenize:function(t,e,n){var s,i,r,o=this.tokens.length,h=0,u=0;for(this.isRequired=!this.foundOne,this.ERROR=!1,this.streamPos=t.pos,this.stackPos=e.stack.length,r=0;o>r;r++){if(i=this.tokens[r],s=i.tokenize(t,e,n),h+=i.isRequired?1:0,!1!==s)return this.foundOne=!0,this.isRequired=!1,this.ERROR=!1,this.pushToken(e.stack,this.clone("tokens","foundOne")),this.foundOne=!1,s;i.ERROR&&(u++,t.backTo(this.streamPos))}return this.ERROR=this.foundOne?!1:!0,!1}}),me=s({Extends:le},{constructor:function(t,e){this.type=A,t&&(this.name=t),e&&this.buildTokens(e),this.tokenName=this.name},tokenize:function(t,e,n){var s,i,r,o=this.tokens.length,h=0,u=0;for(this.isRequired=!0,this.ERROR=!1,this.streamPos=t.pos,r=0;o>r;r++){if(i=this.tokens[r],s=i.tokenize(t,e,n),h+=i.isRequired?1:0,!1!==s)return s;i.ERROR&&(u++,t.backTo(this.streamPos))}return this.isRequired=h>0?!0:!1,this.ERROR=o==u&&h>0?!0:!1,!1}}),de=s({Extends:le},{constructor:function(t,e){this.type=S,t&&(this.name=t),e&&this.buildTokens(e),this.tokenName=this.name},tokenize:function(t,e,n){var s,i,r=this.tokens.length,o=!1;if(this.isRequired=!0,this.ERROR=!1,this.streamPos=t.pos,this.stackPos=e.stack.length,s=this.tokens[0],i=s.required(!0).tokenize(t,e,n),!1!==i){this.stackPos=e.stack.length;for(var h=r-1;h>0;h--)this.pushToken(e.stack,this.tokens[h].required(!0),r-h);o=i}else s.ERROR?(this.ERROR=!0,t.backTo(this.streamPos)):s.isRequired&&(this.ERROR=!0);return o}}),Re=s({Extends:le},{constructor:function(t,e){this.type=q,t&&(this.name=t),e&&this.buildTokens(e),this.tokenName=this.tokens[0].name},tokenize:function(t,e,n){var s,i,r=this.tokens.length,o=!1;if(this.isRequired=!1,this.ERROR=!1,this.streamPos=t.pos,this.stackPos=e.stack.length,s=this.tokens[0],i=s.required(!1).tokenize(t,e,n),!1!==i){this.stackPos=e.stack.length;for(var h=r-1;h>0;h--)this.pushToken(e.stack,this.tokens[h].required(!0),r-h);o=i}else s.ERROR&&t.backTo(this.streamPos);return o}}),ge=function(t,e,s,i,r,o,h,u,c){var a,l,k,p,f,m=null;if(!c[t]){if(a=i[t]||r[t]||null)if(l=a.type||"simple",l=z[l.toUpperCase()],f=a.action||null,P==l)m=new ce(t,oe(t,a.tokens.slice(),e,h,u),l,o[t]||n,a.multiline);else if(b==l)m=new ae(t,oe(t,a.tokens.slice(),e,h,u),l,o[t]||n,a.escape||"\\",a.multiline||!1);else if(T==l)m=new ue(t,ie(t,a.tokens.slice(),e,s[t],h,u),l,o[t]||n);else if(C==l){k=N[a.match.toUpperCase()],p=D(a.tokens).slice();for(var d=0,R=p.length;R>d;d++)p[d]=ge(p[d],e,s,i,r,o,h,u,c);m=w==k?new ke(t,p):L==k?new pe(t,p):_==k?new fe(t,p):A==k?new me(t,p):new de(t,p)}else if(q==l){m=K(D(a.tokens).slice()).slice();for(var d=0,R=m.length;R>d;d++){for(var g=m[d],y=0,E=g.length;E>y;y++)g[y]=ge(g[y],e,s,i,r,o,h,u,c);m[d]=new Re(t+"_NGRAM_"+d,g)}}c[t]=m}return c[t]},ye=s({constructor:function(t,e){this.LOCALS=e,this.Style=t.Style||{},this.tokens=t.Parser||[]},LOCALS:null,Style:null,tokens:null,getLineTokens:function(t,e,n){var s,i,r,o,h,u,c,a,l=this.tokens.length,k=this.Style.error||"error",p=this.LOCALS.DEFAULT;for(c=new F(t),o=[],e=e||new he,e=e.clone(),e.id=1+n,a=e.stack,h={type:null,value:""},u=null;!c.eol();)if(i=!1,u&&u!==h.type?(h.type&&o.push(h),h={type:u,value:c.current()},c.shift()):h.type&&(h.value+=c.current(),c.shift()),c.eatSpace())e.currentToken=B,u=p;else{for(;a.length&&!c.eol();){if(r=a.pop(),u=r.tokenize(c,e,this.LOCALS),!1!==u){i=!0;break}if(r.ERROR||r.isRequired){a.length=0,c.next(),e.currentToken=x,u=k,i=!0;break}}if(!i){if(!c.eol())for(s=0;l>s;s++){if(r=this.tokens[s],u=r.tokenize(c,e,this.LOCALS),!1!==u){i=!0;break}if(r.ERROR||r.isRequired){a.length=0,c.next(),e.currentToken=x,u=k,i=!0;break}}i||c.eol()||(c.next(),e.currentToken=B,u=p)}}return u&&u!==h.type?(h.type&&o.push(h),o.push({type:u,value:c.current()})):h.type&&(h.value+=c.current(),o.push(h)),h={type:null,value:""},{state:e,tokens:o}}}),Ee=function(t,e){return new ye(t,e)},Oe={RegExpID:null,RegExpGroups:null,Style:{error:"error"},Lex:null,Syntax:null,Parser:null},ve=function(t){var e,n,s,i,r,o,h,u,c,a,k,p={},f={},m={};if(t.__parsed)return t;for(t=$(t,Oe),e=t.RegExpID||null,t.RegExpID=null,delete t.RegExpID,n=t.RegExpGroups||{},t.RegExpGroups=null,delete t.RegExpGroups,h=t.Lex||{},t.Lex=null,delete t.Lex,u=t.Syntax||{},t.Syntax=null,delete t.Syntax,o=t.Style||{},r=t.Parser||[],i=r.length,s=[],c=0;i>c;c++)a=r[c],k=ge(a,e,n,h,u,o,p,f,m)||null,k&&(l==I(k)?s=s.concat(k):s.push(k));return t.Parser=s,t.Style=o,t.__parsed=!0,t},xe={VERSION:r,extend:$,parse:ve,getMode:function(t,e){n="text",t=ve(t);var s={DEFAULT:e||n},i=Ee(t,s),r={getTokenizer:function(t){return function(){return t}}(i),HighlightRules:null,$behaviour:null,lineCommentStart:"",blockComment:"",toggleCommentLines:function(){return!1},toggleBlockComment:function(){},getNextLineIndent:function(t,e){return e.match(/^\s*/)[0]},checkOutdent:function(){return!1},autoOutdent:function(){},$getIndent:function(t){return t.match(/^\s*/)[0]},createWorker:function(){return null},createModeDelegates:function(){},$delegator:function(){},transformAction:function(){},getKeywords:function(){return[]},$createKeywordList:function(){return[]},getCompletions:function(){return[]}};return r}};t.AceGrammar=xe}});