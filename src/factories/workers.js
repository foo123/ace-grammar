    ...
    if ( isWorker )
    {
        ...
        /* ace modules needed by worker, hardcoded here ?? */
        ace.define('ace/grammar_worker', ['require', 'exports', 'module' , 'ace/worker/mirror'], function(require, exports, module) {


        var Mirror = require("./worker/mirror").Mirror;
        var AceGrammarWorker = exports.AceGrammarWorker = Class(Mirror, {

            constructor: function(sender) {
                this.$super('constructor', sender);
                this.setTimeout(500);
            },
            
            parser: null,
            
            __init__: function( grammar, id ) {
